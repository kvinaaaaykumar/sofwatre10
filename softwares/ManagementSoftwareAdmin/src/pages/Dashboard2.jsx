    ...
    <div className="p-6 max-w-5xl mx-auto">
      ...
      <div className="text-center mb-5">
        <h2 className="text-slate-700 text-3xl sm:text-4xl font-bold">
          Management Software Admin
        </h2>
      </div>

      {/* View Modal */}
      {viewModalOpen && selectedEntry && (
        <div className="fixed overflow-y-auto pt-[50px] inset-0 flex items-center justify-center bg-black/50 backdrop-blur-sm z-50">
          <div className="bg-white/90 backdrop-blur-lg rounded-2xl shadow-2xl p-8 w-full max-w-lg relative animate-fadeIn border border-gray-200">
            {/* Close Button */}
            <button
            ...
            <div className="grid grid-cols-1 gap-4 text-gray-700">
              ...
              <div className="p-3 bg-gray-50 rounded-xl shadow-sm flex items-center gap-3">
                ...
                <p>
                  <strong>Gender:</strong> {selectedEntry.age}
                </p>
              </div>
              ...
              <div className="p-3 bg-gray-50 rounded-xl shadow-sm flex items-center gap-3">
                ...
                <p>
                  <strong>Mobile Number:</strong> {selectedEntry.mobileNumber}
                </p>
              </div>
      ...
      <button
        ...
        className="flex items-center gap-2 px-5 py-2.5 rounded-full text-white font-medium shadow-md 
             bg-gradient-to-r from-blue-500 to-blue-700 
             hover:from-blue-600 hover:to-blue-800 
             transition transform hover:scale-105 active:scale-95 mb-4"
      >
        {editId ? (
          <>
      ...
      <button
        ...
        className={`px-4 py-2 rounded-xl mb-4 flex items-center gap-2 shadow-lg border transition-all duration-300 ${
          downloading
            ? "bg-gray-400 text-white cursor-not-allowed"
            : "bg-gradient-to-r from-green-500 to-green-700 text-white border-green-300 hover:from-green-600 hover:to-green-800 hover:scale-105"
        }`}
      >
        {downloading ? (
          <>
          ...
          <>
            <FaFileExcel className="text-lg" /> Download Excel
          </>
        )}
      </button>
